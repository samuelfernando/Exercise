 ...
 */
package uk.ac.shef.zeno.kinect;
...
import uk.ac.shef.zeno.simon.SimonApp;
import uk.ac.shef.zeno.simon.PositionPanel;
...
public class UserViewer extends Component
    ...
    public UserViewer(UserTracker tracker, PositionPanel panel, KinectVideoRecorder videoRecorder) {
        mTracker = tracker;
        museumApp = new SimonApp(mTracker, panel, videoRecorder);
